 ...
 * algorithm used by {LineReader}. Line separators are per {@link
...
abstract class LineBuffer {
	 ...
	 *
	 * @param cbuf
	 * 		the character buffer to process
	 * @param off
	 ...
	 *
	 * @param line
	 * 		a line of text (possibly empty), without any line separators
	 * @param end
	 * 		the line separator; one of {@code "\r"}, {@code "\n"},
	 * 		{@code "\r\n"}, or {@code ""}
	 *
	 * @throws IOException
	 * 		if an I/O error occurs
