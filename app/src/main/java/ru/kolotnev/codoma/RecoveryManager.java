...
//		String encoding = _persistence.getString(STATE_ENCODING, EncodingScheme.TEXT_ENCODING_UTF8);
//		String eolChar = _persistence.getString(STATE_EOL, EncodingScheme.LINE_BREAK_LF);
//
//		//allocate buffer
