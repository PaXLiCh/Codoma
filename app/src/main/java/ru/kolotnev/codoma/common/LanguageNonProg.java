...
public class LanguageNonProg extends Language {
	...
	public static Language getInstance() {
		if(_theOne == null) { _theOne = new LanguageNonProg(); }
		return _theOne;
	}

	@Override
	public boolean isProgLang() { return false; }

	@Override
	public boolean isEscapeChar(char c) { return false; }

	@Override
	public boolean isDelimiterA(char c) { return false; }

	@Override
	public boolean isDelimiterB(char c) { return false; }
	...
	@Override
	public boolean isMultilineEndDelimiter(char c0, char c1) { return false; }
}
