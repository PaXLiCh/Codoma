...
public class AnalyzeStatisticsThread extends Thread implements ProgressSource {
	...
	@Override
	public final int getMin() { return 0; }

	@Override
	public int getMax() { return Math.max(1, _end - _start); }

	@Override
	public int getCurrent() { return _analyzer.getProgress(); }

	@Override
	public final boolean isDone() { return _isDone; }

	public final CharEncodingUtils.Statistics getResults() { return _results; }
}
