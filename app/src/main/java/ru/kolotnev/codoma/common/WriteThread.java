...
public class WriteThread extends FileIOThread {
	...
	public WriteThread(File file, DocumentProvider hDoc, String encoding, String EOLchar) {
		...
		TextWarriorException.assertVerbose(_totalChar > 0, "File to save must have at least 1 char");
	}
	...
	public void run() {
		...
		try {
			...
			broadcastError(ProgressSource.WRITE, ERROR_UNKNOWN, ex.getLocalizedMessage());
		}
	}
	...
	@Override
	public int getMax() { return MAX_PROGRESS; }
