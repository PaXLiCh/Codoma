...
/**
 * Created by pavelkolotnev on 09.08.16.
 */
...
// A color scheme by Chris Kempson (http://chriskempson.com)
	...
	static {
		...
		support_class.color = yellow;
		support_function.color = cyan;
		support_function_any_method.color = blue;
		entity_name_function.color = blue;
		entity_name_class.color = yellow;
		entity_name_type_class.color = yellow;
		entity_name_section.color = blue;
		entity_name_tag.color = red;
		entity_other_attribute_name.color = orange;
		entity_other_attribute_name_id.color = blue;
		meta_class.color = yellow;
		meta_link.color = orange;
		meta_require.color = blue;
		meta_selector.color = purple;
